...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "vishal@apptimize.com:hello", "karen@apptimize.com:world"
    };
    /**
...
//        populateAutoComplete();
        ...
        ApptimizeOptions options = new ApptimizeOptions();
        options.setLogLevel(ApptimizeOptions.LogLevel.VERBOSE);
        Apptimize.setup(this, getString(R.string.apptimize_key), options);
    }
